...
syn region boardRegion start="^[^#:\- ]\+" end="$\n^[^# ]"me=e-1 transparent contains=
  \ BoardSection,BoardGroup,BoardLed1,BoardMarker,BoardLed2,BoardLed3,BoardComment,BoardSpecial,BoardPlain

syn region BoardConfig start="^:" end="$\n^[^# ]"me=e-1 contains=
  \ BoardConfig,BoardLink,BoardGroup,BoardMarker,BoardJumper,BoardComment,BoardSpecial,BoardPlain
